...
let
  ...
  brokenPackages = [
    "charm" # broken dependency
    "ChAMPdata" # broken dependency
    ...
    "caretEnsemble" # broken dependency
    "caret" # broken dependency
    "CardinalWorkflows" # broken dependency
    "CARBayes" # broken dependency
    "car" # broken dependency
    ...
    "BSgenome_Hsapiens_UCSC_hg38" # broken dependency
    "BSgenome_Hsapiens_UCSC_hg19_masked" # broken dependency
    "BSgenome_Hsapiens_UCSC_hg19" # broken dependency
    "BSgenome_Hsapiens_UCSC_hg18_masked" # broken dependency
    "BSgenome_Hsapiens_UCSC_hg18" # broken dependency
    "BSgenome_Hsapiens_UCSC_hg17_masked" # broken dependency
    "BSgenome_Hsapiens_UCSC_hg17" # broken dependency
    ...
    "BSgenome_Drerio_UCSC_danRer6" # broken dependency
